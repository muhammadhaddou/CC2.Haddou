<aside class="w-64 bg-white shadow-sm border-r hidden md:flex flex-col">
    <div class="h-full px-4 py-6 overflow-y-auto">
        <ul class="space-y-4 font-medium">
            ...
            <li>
                <a href="/appointments" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group {{ request()->routeIs('appointments.*') ? 'bg-gray-100' : '' }}">
